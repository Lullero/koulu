...
public class KirjautuminenHinnat extends JFrame {
	...
	private HintojenYllapito hintojenyllapito = new HintojenYllapito();
		...
		Nappi_kirjaudu.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (textField_ktunnus.getText().equals(oikea_tunnus) && oikea_ssana.equals(salasana_crypted)) {
					KirjautuminenHinnat.this.setVisible(false); 
					hintojenyllapito.setVisible(true); 
				}
				else {
